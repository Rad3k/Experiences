<%@ Page Title="Manage" Language="C#" MasterPageFile="~/admin/manage.Master" AutoEventWireup="true" CodeBehind="manage-stream-hRight.aspx.cs" Inherits="rad3k_eu.admin.manage_stream_hRight" %>
